          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              <div className="bg-[#0077B6]/10 p-2 rounded-full mr-3 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-[#0077B6]">
                  ...
                  <path d="M15.584 17a9 9 0 1 0-7.168 0"></path>
            ...
            <div className="flex items-start">
              <div className="bg-[#0077B6]/10 p-2 rounded-full mr-3 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-[#0077B6]">
                  <path d="M8 6h8"></path>
                  <path d="M15 18h-4a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2z"></path>
                  <path d="M17 12h1a2 2 0 0 0 2-2v0a2 2 0 0 0-2-2h-1"></path>
                  <path d="M7 12H6a2 2 0 0 1-2-2v0a2 2 0 0 1 2-2h1"></path>
                  <path d="M12 4v4"></path>
                  <path d="M12 18v2"></path>
                </svg>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800">World Health Organization (WHO)</h3>
                <p className="text-gray-600 mb-2">
                  Health-related travel advisories and disease outbreak information.
                </p>
                <a 
            ...
            <div className="flex items-start">
              <div className="bg-[#0077B6]/10 p-2 rounded-full mr-3 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-[#0077B6]">
                  <path d="M19.5 14c-1.23 0-2.23 1-2.23 2.23v.04c0 1.23 1 2.23 2.23 2.23h.04c1.23 0 2.23-1 2.23-2.23v-.04c0-1.23-1-2.23-2.23-2.23zm0 0h-3.5M5.5 14c-1.23 0-2.23 1-2.23 2.23v.04c0 1.23 1 2.23 2.23 2.23h.04c1.23 0 2.23-1 2.23-2.23v-.04c0-1.23-1-2.23-2.23-2.23zm0 0h-3"></path>
                  <line x1="8" y1="9" x2="16" y2="9"></line>
                  <line x1="8" y1="6" x2="16" y2="6"></line>
                  <line x1="9" y1="17" x2="15" y2="17"></line>
                  <path d="M10 2v2a2 2 0 0 0 4 0V2"></path>
                </svg>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800">Sri Lanka Meteorological Department</h3>
                <p className="text-gray-600 mb-2">
                  Weather forecasts and warnings for all regions of Sri Lanka.
                </p>
                <a 
